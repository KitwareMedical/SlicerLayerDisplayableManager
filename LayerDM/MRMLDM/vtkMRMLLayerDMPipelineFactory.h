...
public:
  ...
  static vtkMRMLLayerDMPipelineFactory* GetInstance();
  ...
  void AddPipelineCreator(vtkMRMLLayerDMPipelineCreatorI* creator);
  ...
  /// Invokes vtkCommand::ModifiedEvent if the factory is modified.
  void RemovePipelineCreator(vtkMRMLLayerDMPipelineCreatorI* creator);

  /// true if the given creator is contained in the factory, false otherwise.
  bool ContainsPipelineCreator(vtkMRMLLayerDMPipelineCreatorI* creator) const;
  ...
  /// \sa GetLastNode
  /// \sa GetLastPipeline
  vtkMRMLLayerDMPipelineI* CreatePipeline(vtkMRMLAbstractViewNode* viewNode, vtkMRMLNode* node);
