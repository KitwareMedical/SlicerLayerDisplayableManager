...
class PipelineManagerTest(ScriptedLoadableModuleTest):
    ...
    def test_dispatches_process_interaction_to_higher_order_pipeline_first(self):
        m1 = self.triggerMockPipelineCreation(MockPipeline(renderOrders=[1]))
        m2 = self.triggerMockPipelineCreation(MockPipeline(renderOrders=[10]))
        m3 = self.triggerMockPipelineCreation(MockPipeline(renderOrders=[100]))
        m4 = self.triggerMockPipelineCreation(MockPipeline(renderOrders=[0]))
    ...
    def test_dispatches_process_to_max_state_first(self):
        ...
        m1 = self.triggerMockPipelineCreation(MockPipeline(renderOrders=[1]))
        m2 = self.triggerMockPipelineCreation(MockPipeline(renderOrders=[1]))
